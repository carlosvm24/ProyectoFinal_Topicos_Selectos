...
class Demo1:
    def __init__(self, master):
        self.master = master
        photo = tk.PhotoImage(file="prueba_1.gif")
        self.frame = tk.Frame(self.master, padx=50, pady=50)
        userlabel = tk.Label(self.master, text='User Name:', bg = "turquoise", fg = "red")
        ...
        self.frame.pack()
        self.master.configure(background="turquoise")
